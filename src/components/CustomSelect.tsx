    ...
    <div ref={rootRef} className={`relative ${className}`}>
      ...
      {isOpen && (
        <div
          id={listId}
          role="listbox"
          className="absolute left-0 right-0 top-full z-[70] mt-2 max-h-[min(16rem,45vh)] touch-pan-y overflow-y-auto overscroll-contain rounded-xl border border-gray-200 bg-white p-1.5 shadow-2xl shadow-gray-900/15 outline-none [-webkit-overflow-scrolling:touch] dark:border-gray-700 dark:bg-gray-900 dark:shadow-black/40"
        >
          {options.map((option) => {
